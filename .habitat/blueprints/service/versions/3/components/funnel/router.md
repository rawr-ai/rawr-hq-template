...
predicate service_v3_router_composition_native_handler($statements) {
  or {
...
predicate service_v3_router_composition_effect_handler($statements) {
  or {
...
or {
  ...
  program(statements=$statements) where {
    ...
    not {
      ...
      or {
        service_v3_router_composition_native_handler(statements=$statements),
        service_v3_router_composition_effect_handler(statements=$statements)
      }
    }
  },
  program(statements=$statements) where {
