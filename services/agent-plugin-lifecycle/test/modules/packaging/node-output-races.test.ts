...
} from "../../../src/service/modules/packaging/internal/atomic-output";
import { createNodeAtomicPackageOutput } from "../../../../../apps/cli/src/lib/agent-plugins/service-runtime/packaging/node-atomic-output";
import { packageDigest } from "../../../../../apps/cli/src/lib/agent-plugins/service-runtime/packaging/node-cowork-v1";
import { captureCanonicalParent, captureOutput } from "../../../../../apps/cli/src/lib/agent-plugins/service-runtime/packaging/node-output-identity";
import {
