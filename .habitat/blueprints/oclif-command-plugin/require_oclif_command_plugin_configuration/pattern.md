  ...
  document(value=$root) where {
    ...
    or {
      not {
        ...
        $name <: r"^\"@(?:rawr/plugin|habitat-ai/(?:plugin|rawr-plugin))-[a-z0-9-]+\"$"
      },
      ...
      and {
        ...
        $plugin_name <: r"^\"@(?:rawr/plugin|habitat-ai/(?:plugin|rawr-plugin))-[a-z0-9-]+\"$"
      },
      and {
...
{
  "name": "@habitat-ai/rawr-plugin-example",
  "version": "1.0.0",
  "type": "module",
...
// @filename: plugins/cli/commands/example/package.json
{
  ...
  "dependencies": {
    "@oclif/core": "4.11.14",
    "@habitat-ai/rawr-plugin-other": "1.0.0"
  },
  "files": ["dist", "oclif.manifest.json"],
