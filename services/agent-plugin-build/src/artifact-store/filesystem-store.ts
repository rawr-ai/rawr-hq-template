...
export interface ArtifactStore {
  ...
  publishRelease(release: AgentPluginRelease, options?: ArtifactPublicationOptions): Promise<ArtifactPublicationResult>;
  publishReleaseSet(releaseSet: AgentPluginReleaseSet, options?: ArtifactPublicationOptions): Promise<ArtifactPublicationResult>;
}
