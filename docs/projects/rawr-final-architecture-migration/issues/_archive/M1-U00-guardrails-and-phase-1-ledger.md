...
- [Implementation Details (Local Only)](#implementation-details-local-only)
	...
	- [Prework Results (Resolved)](#prework-results-resolved)
	- [1) Ledger section structure](#1-ledger-section-structure)
	- [2) Minimum concrete surface inventory to classify](#2-minimum-concrete-surface-inventory-to-classify)
	- [3) Current verification integration points](#3-current-verification-integration-points)
	- [Quick Navigation](#quick-navigation)
- [Implementation Decisions](#implementation-decisions)
	- [Make U00 checks enforce current-lane drift, not future-slice completion](#make-u00-checks-enforce-current-lane-drift-not-future-slice-completion)
