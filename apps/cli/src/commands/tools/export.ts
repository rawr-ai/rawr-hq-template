...
const TOOLS: ToolExport[] = [
  ...
  { command: "sessions list", description: "List Claude/Codex sessions" },
  { command: "sessions resolve <id>", description: "Resolve a session id/path to a file" },
  { command: "sessions search --query-metadata <q>", description: "Search sessions by metadata" },
  { command: "sessions search --query <regex>", description: "Search sessions by transcript content" },
  { command: "sessions extract <id>", description: "Extract a session transcript" },
