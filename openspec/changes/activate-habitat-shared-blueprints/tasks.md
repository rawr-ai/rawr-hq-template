## 1. Seal The Authority Boundary

- [x] 1.1 Validate the package-member, instance, provenance, and release contracts against Template, Magic Migration, and Civ7 evidence.
- [x] 1.2 Record the exact Magic laws promoted, retained locally, or deferred and why.
...
- [ ] 5.1 Land reviewed semantic Graphite checkpoints on canonical Template `main`.
- [ ] 5.2 Advance the fixed SDK/CLI group to `0.5.0`, publish through the trusted npm workflow, and verify registry version, provenance, and installed smoke.
