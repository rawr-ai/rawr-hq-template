...
import { failure, issue, success } from "../src/domain/result";
...
describe("provider deployment state machine", () => {
  ...
  it("isolates one target inverse-source failure from an eligible target", async () => {
    ...
    const codexPriorProjection = `ap1_${"e".repeat(64)}` as import("../src/index").ProjectionDigest;
    const claudePriorProjection = `ap1_${"d".repeat(64)}` as import("../src/index").ProjectionDigest;
...
class Harness {
  ...
  failInverseProjectionDigest: import("../src/index").ProjectionDigest | null = null;
  ...
  seedPriorReleaseReceipt(
    ...
    priorProjectionDigest = `ap1_${"e".repeat(64)}` as import("../src/index").ProjectionDigest,
  ): void {
  ...
  private readPorts() {
    return {
      ...
      provider: {
        ...
        verifyProjection: async (target: ProviderTarget, projection: import("../src/index").AgentProviderProjection) => {
  ...
  private writePorts() {
    return {
      ...
      evidence: {
        inspect: async (digest: import("../src/index").MechanicalEvidenceDigest) => {
        ...
        publish: async (value: import("../src/index").MechanicalProviderEvidence) => {
      ...
      projectionMaterializer: {
        materialize: async (projection: import("../src/index").AgentProviderProjection) => {
      ...
      priorProjections: {
        readArchivedMember: async (
          projectionDigest: import("../src/index").ProjectionDigest,
...
function nativeMember(
  member: import("../src/index").ProviderProjectionMember,
