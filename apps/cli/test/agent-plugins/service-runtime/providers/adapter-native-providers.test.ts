...
import { createProviderMarketplaceRegistration, marketplaceState, type ProviderMarketplaceObservation, type ProviderMarketplaceRegistration } from "@rawr/agent-plugin-lifecycle/ports/providers";
import type { AgentProviderProjection, ProviderMemberFingerprint, ProviderProjectionMember } from "@rawr/agent-plugin-lifecycle/ports/providers";
import { failure, issue, success } from "@rawr/agent-plugin-lifecycle/ports/providers";
...
} from "../../../../src/lib/agent-plugins/service-runtime/providers/adapters/codex";
import {
  CLAUDE_ADAPTER_PROTOCOL,
  createClaudeProviderAdapter,
  type ClaudeNativePlugin,
} from "../../../../src/lib/agent-plugins/service-runtime/providers/adapters/claude";
