...
- Preserve Phase Two as contained proof work, not production migration or Phase
...
- The scenario pair is lab-local and production-critical. It is not production
  topology, final public API design, or production migration readiness.
