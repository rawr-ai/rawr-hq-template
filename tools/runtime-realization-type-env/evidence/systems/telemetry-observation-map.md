...
| Migration/control-plane packet | `audit.migration.control-plane-observation`, `audit.migration.control-plane-observation.residual` | `../../phases/phase-one/workstreams/workstream-2026-04-30-phase-one-migration-control-plane-observation.md`; `../../src/runtime/observation/migration-control-plane-observation.ts` |
