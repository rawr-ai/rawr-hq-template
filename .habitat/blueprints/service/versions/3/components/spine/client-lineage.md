...
predicate service_v3_client_lineage_native($statements, $name, $source) {
  or {
...
program(statements=$statements) where {
  ...
  not {
    ...
    service_v3_client_lineage_native(statements=$statements, name=$create, source=`"@orpc/server"`),
    or {
