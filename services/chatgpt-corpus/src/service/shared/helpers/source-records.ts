...
import type {
  ...
  SourceRecord,
} from "../../modules/source-materials/entities";
import { RawConversationExportSchema } from "../../modules/source-materials/entities";

export type SourceRecordNormalizationError =
  | { kind: "invalid-json"; sourcePath: string; reason: string }
  | { kind: "invalid-export"; sourcePath: string; reason: string };
