...
1. [Dedicated Phase 1 migration plan](../../.context/M1-execution/RAWR_P1_Architecture_Migration_Plan.md): the forward-locked decision set for Phase 1 scope, sequencing, fixed decisions, and exit gate.
2. [Canonical architecture spec](../../resources/_archive/RAWR_Canonical_Architecture_Spec_V1.md): destination architecture and invariant truth.
...
| --- | --- | --- | --- |
| `M1-U00` | [Guardrails and Phase 1 ledger](../issues/_archive/M1-U00-guardrails-and-phase-1-ledger.md) | none | Install the ledger and proof rails that freeze the migration lane before any authority moves begin. |
| `M1-U01` | [Archive false futures](../issues/_archive/M1-U01-archive-false-futures.md) | `M1-U00` | Remove `coordination` and `support-example`, then freeze the current Cloud Code/Codex marketplace plugin lane so it stops steering Phase 1 topology decisions. |
| `M1-U02` | [Reserve the canonical HQ Ops seam](../issues/_archive/M1-U02-reserve-hq-ops-seam.md) | `M1-U01` | Create the one canonical service home for Phase 1 so semantic truth has a real destination before it moves. |
| `M1-U03` | [Migrate HQ operational truth into HQ Ops and rewire consumers](../issues/_archive/M1-U03-migrate-hq-ops-and-rewire-consumers.md) | `M1-U02` | Collapse config, repo-state, journal, and security authority into HQ Ops before any runtime projection or app-shell work proceeds. |
| `M1-U04` | [Dissolve the legacy HQ package and land purpose-named tooling boundaries](../issues/_archive/M1-U04-dissolve-legacy-hq-package.md) | `M1-U03` | Delete the ambiguous `packages/hq` layer once real semantic authority is installed elsewhere. |
| `M1-U05` | [Cut the canonical plugin topology](../issues/_archive/M1-U05-cut-canonical-plugin-topology.md) | `M1-U04` | Move the runtime-projection tree onto the canonical role-first plugin layout after semantic owners and tooling boundaries are stable. |
| `M1-U06` | [Install the canonical HQ app shell](../issues/_archive/M1-U06-install-canonical-hq-app-shell.md) | `M1-U05` | Make the canonical HQ front door real only after service truth and plugin topology are trustworthy. |
| `M1-U07` | [Neutralize legacy executable composition authority](../issues/_archive/M1-U07-neutralize-legacy-composition-authority.md) | `M1-U06` | Remove the old host-composition path only after the new app shell is already live and smoke-tested. |
| `M1-U08` | [Ratchet Phase 1 proofs, land durable docs, and readjust the migration](../issues/_archive/M1-U08-ratchet-phase-1-proofs-and-readjust.md) | `M1-U07` | Freeze the Phase 1 plateau, land only settled docs, and run the formal review that hands off into Phase 2. |

### M1-U00: Guardrails and Phase 1 ledger

- Issue doc: [M1-U00](../issues/_archive/M1-U00-guardrails-and-phase-1-ledger.md)
...
- Issue doc: [M1-U01](../issues/_archive/M1-U01-archive-false-futures.md)
...
- Issue doc: [M1-U02](../issues/_archive/M1-U02-reserve-hq-ops-seam.md)
...
- Issue doc: [M1-U03](../issues/_archive/M1-U03-migrate-hq-ops-and-rewire-consumers.md)
...
- Issue doc: [M1-U04](../issues/_archive/M1-U04-dissolve-legacy-hq-package.md)
...
- Issue doc: [M1-U05](../issues/_archive/M1-U05-cut-canonical-plugin-topology.md)
...
- Issue doc: [M1-U06](../issues/_archive/M1-U06-install-canonical-hq-app-shell.md)
...
- Issue doc: [M1-U07](../issues/_archive/M1-U07-neutralize-legacy-composition-authority.md)
...
- Issue doc: [M1-U08](../issues/_archive/M1-U08-ratchet-phase-1-proofs-and-readjust.md)
...
- [Phase 1 Closeout Review](../../.context/M1-execution/phase-1-closeout-review.md)
