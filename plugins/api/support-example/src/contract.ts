...
export const supportExampleApiContract = oc.router({
  supportExample: oc.router({
    requestWorkItem: oc
      .route({
        method: "POST",
        path: "/support-example/work-items",
    ...
    getWorkItem: oc
      .route({
        method: "GET",
        path: "/support-example/work-items/{workItemId}",
        tags: supportExampleTag,
    ...
    startWorkItem: oc
      .route({
        method: "POST",
        path: "/support-example/work-items/{workItemId}/start",
        tags: supportExampleTag,
    ...
    completeWorkItem: oc
      .route({
        method: "POST",
        path: "/support-example/work-items/{workItemId}/complete",
        tags: supportExampleTag,
