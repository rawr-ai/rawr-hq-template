# agent-provider-deployment Specification

## Purpose
Define live-native observation and target-scoped reconciliation for Codex and
Claude homes, including collision safety, partial outcomes, retry, and
idempotence.
## Requirements
