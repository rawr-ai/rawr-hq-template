...
- `tools/runtime-realization-type-env/phases/phase-one/workstreams/workstream-2026-04-30-phase-one-runtime-telemetry-hyperdx-observation.md`
- `tools/runtime-realization-type-env/phases/phase-one/workstreams/workstream-2026-04-30-phase-one-migration-control-plane-observation.md`

Cautionary provenance, read last:

- `tools/runtime-realization-type-env/phases/phase-one/workstreams/workstream-2026-04-30-phase-one-runtime-prod-contamination-lessons.md`
...
The Runtime Realization Lab is a contained spec-conformance laboratory under
...
- vendor proof for real Effect `3.21.2`, TypeBox, native oRPC shape, and
  ...
  integration;
- contained oracle proof for descriptor table and registry identity,
  ...
  packets;
- contained HyperDX/OTLP observation proof that already-redacted oracle
...
`simulation-proof` is not Lab-Production Proof. Closeout is explicitly
`out-of-scope` coordination, not runtime behavior.

## What Phase Two Is For

Phase two should be a new contained proof program inside the Runtime Realization Lab.
...
Phase two should also burn down the critical Lab-Production Proof spine implied
by the runtime spec:
...
- Provider/resource/config/secret behavior is representative enough to inform
  Parent-Repo Migration planning, including validation, redaction, acquire,
...
That delta matters because Parent-Repo Migration planning needs more than
"types compile" and more than "the Oracle simulation works." It needs to
...
Phase three then remains inside the Runtime Realization Lab but changes the
question from "can the runtime spine earn Lab-Production Proof?" to "can this
proven spine be arranged in the Reference Runtime structure and locked with
Nx?"
...
- identify whether any existing workstream evidence overstates vendor,
  HyperDX, route, async, or Lab-Production Proof claims;
