...
const PASS_ROOT =
  "docs/projects/orpc-ingest-workflows-spec/_phase-e-runtime-execution-pass-01-2026-02-21";
...
assertScriptEquals(
  scripts,
  "phase-e:gate:e3-evidence-integrity",
  "bun scripts/phase-e/verify-e3-evidence-integrity.mjs"
);
assertScriptEquals(
  scripts,
  "phase-e:e3:quick",
...
if (mode === "e4-disposition") {
  ...
  const mentionsTriggeredEvidence = /triggered|trigger[_-]evidence|E4_TRIGGER_EVIDENCE\.md/u.test(
    dispositionSource
  );
