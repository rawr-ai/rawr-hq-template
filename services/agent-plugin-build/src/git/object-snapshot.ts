...
export interface ContentWorkspaceSnapshot {
  ...
  readonly objectBindings: readonly Readonly<{ path: ReleaseRelativePath; objectId: string; mode: number }>[];
...
export type ContentWorkspaceInspection =
  ...
  | Readonly<{ kind: "Ineligible"; issues: readonly [SourceEligibilityIssue, ...SourceEligibilityIssue[]] }>;
