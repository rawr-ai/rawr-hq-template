...
- Parent waits around readability repair remained stuck after artifacts existed and were hash-valid. The service gates passed, but normal child completion for the repair pass is not proven and should be investigated before claiming smooth long-run runtime operation.
