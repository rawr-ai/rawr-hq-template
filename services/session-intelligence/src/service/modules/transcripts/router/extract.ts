import type { SessionMessage } from "../../../model/dto";
import {
  detectSessionFormat,
...
/** Extracts one normalized transcript from a supported provider record. */
export const extract = module.extract.handler(async ({ context, input, errors }) => {
