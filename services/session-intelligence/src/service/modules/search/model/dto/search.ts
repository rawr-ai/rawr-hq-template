...
import { SessionListItemSchema } from "../../../../model/dto";

/**
 * search module entities.
 *
 * @remarks
 * These are shared between the contract boundary and search policy without
 * making the contract entrypoint an implementation dependency.
 */
