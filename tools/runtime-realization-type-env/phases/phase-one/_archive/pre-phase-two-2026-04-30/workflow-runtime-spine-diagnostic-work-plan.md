...
4. Diagnostic report.
   ...
   - Include next validation moves: resolve now, container experiment, parent-repo-migration.
...
- Report distinguishes type proof, vendor-shape proof, simulation proof, xfail/todo, and parent-repo-migration gaps.
