...
function parseApproval(
  ...
  if (!sameGitPointer(object.value, query.object) || record.outcome !== query.outcome) {
    return failure("WrongObject", "Hosted approval is bound to another repository/ref/commit/tree/path/blob/outcome");
  }
  return {
    ok: true,
