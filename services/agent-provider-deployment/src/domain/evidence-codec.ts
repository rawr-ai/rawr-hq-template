import { parseArtifactRef, type CompleteSetArtifactRef, type ReleaseArtifactRef } from "@rawr/agent-plugin-release";
...
import type { AdapterProtocol, CapabilityProfileDigest, ProjectionDigest } from "./projection";
import { failure, firstIssue, issue, success, type DeploymentResult, type ProviderDeploymentIssue, type ProviderDeploymentIssueCode } from "./result";
import type { ProviderId, ProviderTargetDigest } from "./target";
...
const FAILURE_CODES = new Set<ProviderDeploymentIssueCode>([
  ...
  "BLOCKED_CANONICAL_TEST_TARGET", "BLOCKED_COLLISION", "CAPABILITY_MISMATCH", "CAPSULE_FAILED",
