...
- `workstream-2026-04-30-phase-two-prelaunch-workspace-preparation.md`
- `../README.md`
...
- The prelaunch assumption that `current-lab-state.md` and `proof-manifest.currentExperiment`
...
| Diagnostic stays honest about proof strength. | Diagnostic keeps most spine components yellow and states that vendor/simulation proof is not Lab-Production Proof. | Pass. | High |
...
| HyperDX live smoke is not a standing regression gate. | Manifest gate for `audit.telemetry.hyperdx-observation` is `typecheck` plus `oracle`; local HyperDX ingest smoke is recorded workstream evidence. | Record as residual for child workstream 6; no proof promotion. | High |
...
- `tools/runtime-realization-type-env/evidence/vendors/README.md`
- `workstream-2026-04-30-phase-one-runtime-prod-contamination-lessons.md`, read last
