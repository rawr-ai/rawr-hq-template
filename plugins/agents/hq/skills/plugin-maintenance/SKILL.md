...
- Authoring never triggers build, package, export, sync, promotion, or undo
  automatically.
...
`rawr agent plugins status`, `rawr agent plugins attest-promotion`, and
`rawr agent plugins undo`.
