...
const [scripts, orpcSource, metricsTestSource, bootstrapTestSource, serverPackageRaw] =
  await Promise.all([
    readPackageScripts(),
...
assertCondition(
  metricsTestSource.includes("rawr.orpc.rpc.request") &&
    metricsTestSource.includes("rawr.orpc.openapi.request"),
