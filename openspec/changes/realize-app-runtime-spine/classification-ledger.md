...
Task 4.7d is sealed as the final documentation-only correction before task 4.8
...
Only after task 4.7d is complete, task 4.8 is the sole active source node under
