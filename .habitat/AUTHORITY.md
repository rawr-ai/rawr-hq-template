...
3. Service code depends on resource contracts rather than concrete providers or
   ...
   around declared bindings, provider projection, composition, and
   controller-owned undo. Concrete provider construction remains outside the
   semantic service and release/evidence projections, where filesystem or
   process mechanics cannot accumulate.
