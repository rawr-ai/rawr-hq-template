...
- [Implementation Details (Local Only)](#implementation-details-local-only)
  ...
  - [1) Phase 1 close-out review checklist](#1-phase-1-close-out-review-checklist)
  - [2) Docs outside the migration project that will become stale](#2-docs-outside-the-migration-project-that-will-become-stale)
  - [3) Docs that should be left untouched](#3-docs-that-should-be-left-untouched)
