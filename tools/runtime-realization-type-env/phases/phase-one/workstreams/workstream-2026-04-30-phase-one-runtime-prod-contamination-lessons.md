...
contained oracle had proven the next production-critical spine. That was
...
into the oracle, and do not treat their APIs as target shapes.
...
readiness` for this next oracle program.
...
workstream under `tools/runtime-realization-type-env/guidance/`.
