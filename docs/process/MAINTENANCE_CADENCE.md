...
- The repository-local Oclif CLI must start from checked-out Template source.
...
When advancing Habitat, publish a reviewed Template-owned Nx release group
...
RAWR HQ-Template owns Habitat source, releases, policy, and its own consumer
