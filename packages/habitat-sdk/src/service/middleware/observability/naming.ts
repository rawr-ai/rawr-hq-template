...
/** Derives one service's signal names and attribute prefixes. */
export function deriveServiceNames(baseMetadata: BaseMetadata, attributeNamespace: string) {
  ...
  return {
    ...
    orpcAttributePrefix: `${attributeNamespace}.orpc`,
    serviceAttributePrefix: `${attributeNamespace}.${domain}`,
  };
}
