# app-runtime-realization Specification

## Purpose
Define how app-owned cold composition becomes an isolated running process through
Habitat's seven-phase runtime, preserving exact artifact handoffs, managed resource
and service lifetimes, native execution boundaries, and accepted public package
interfaces.
## Requirements
