...
import { createProviderMarketplaceRegistration, marketplaceState, type ProviderMarketplaceObservation, type ProviderMarketplaceRegistration } from "../src/domain/marketplace";
import type { AgentProviderProjection, ProviderMemberFingerprint, ProviderProjectionMember } from "../src/domain/projection";
import { failure, issue, success } from "../src/domain/result";
import type { NativeMemberObservation } from "../src/domain/state";
import { parseProviderTarget } from "../src/domain/target";
import {
