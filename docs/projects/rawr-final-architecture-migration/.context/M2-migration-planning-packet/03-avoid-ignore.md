...
| Superseded migration plans or milestone text that predates the final runtime/canonical spec decisions | Useful history can turn into stale requirements if not reconciled first. |
