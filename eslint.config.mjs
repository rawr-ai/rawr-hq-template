...
export default [
  ...
  {
    files: [
      "apps/**/*.{js,jsx,ts,tsx,cts,mts}",
      "services/**/*.{js,jsx,ts,tsx,cts,mts}",
      "packages/**/*.{js,jsx,ts,tsx,cts,mts}",
      "plugins/**/*.{js,jsx,ts,tsx,cts,mts}",
      "resources/**/*.{js,jsx,ts,tsx,cts,mts}",
    ],
    rules: {
          ...
          patterns: [
            {
              ...
              message:
                "The legacy @rawr/agent-sync package is removed; curated lifecycle belongs to the typed @rawr/agent-plugin-lifecycle service boundary.",
            },
            {
              group: ["@rawr/session-tools", "@rawr/session-tools/*"],
              message:
                "The legacy @rawr/session-tools package is removed; use @rawr/session-intelligence and plugin/app-local concrete resources.",
            },
            {
              group: ["@rawr/*-host", "@rawr/*-host/*"],
              message:
                "Service-specific host packages are forbidden. Services own semantics; plugin/app/runtime surfaces provide concrete resources.",
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                "Session Intelligence service files must stay runtime-agnostic; concrete filesystem, env, and SQLite access belongs in the plugin/app resource binding layer.",
            },
          ],
        },
      ],
