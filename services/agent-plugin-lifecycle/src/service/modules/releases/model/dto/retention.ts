...
export const RetentionRefSchema = Type.Union([ArtifactRefSchema, MechanicalEvidenceHandleSchema]);

export const RetentionIssueSchema = ReadonlyObject(
  Type.Object({
...
export const RetentionPinsV1Schema = ReadonlyObject(
  Type.Object({
...
export const RetentionInventoryEntrySchema = ReadonlyObject(
  Type.Object({
...
export const RetentionInventoryEntryInputSchema = ReadonlyObject(
  Type.Object({
...
export const PlanRetentionInputSchema = ReadonlyObject(
  Type.Object({
...
export const RetentionPlanSchema = ReadonlyObject(
  Type.Object({
    kind: Type.Literal("RetentionPlan"),
    pinned: ReadonlyObject(Type.Array(RetentionRefSchema), { maxItems: MAX_RETENTION_REFS }),
    retained: ReadonlyObject(Type.Array(RetentionInventoryEntrySchema), {
      maxItems: MAX_RETENTION_REFS,
    }),
    collectible: ReadonlyObject(Type.Array(RetentionInventoryEntrySchema), {
      maxItems: MAX_RETENTION_REFS,
    }),
    blockedEntries: ReadonlyObject(Type.Array(RetentionIssueSchema), {
      maxItems: MAX_RETENTION_REFS,
    }),
  }),
  { additionalProperties: false }
...
export const RetentionPlanBlockedSchema = ReadonlyObject(
  Type.Object({
