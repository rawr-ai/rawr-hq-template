...
function spineClient(
  ...
  const deps: Deps = {
    ...
    exports: {
      ...
      destinationRuntime: {
        captureDestination: async () => unavailableAsync("export destination capture"),
        buildDestinationExportPlan: async () => unavailableAsync("export planning"),
        executeDestinationPlan: async () => unavailableAsync("export mutation"),
      },
    },
