...
4. Explicit lab declarations and cold route factories can flow through derivation, compilation, adapter lowering payloads, contained server/async harness mounts, bootgraph/catalog records, runtime access/cache checks, adapter delegation, deployment handoff boundaries, telemetry export, and a non-persistent migration observation packet.
