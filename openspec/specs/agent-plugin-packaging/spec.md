...
## Purpose
Define deterministic explicit-output packaging of selected content, including
Cowork as package-only, without persistent lifecycle state or provider mutation.
## Requirements
