...
- Default program sequence from
  `../_archive/default-research-program-2026-04-30/workflow-runtime-research-program-dra.md`: workstream 4 is
  `Dispatcher Access + Async Step Membership`.
...
- `workstream-2026-04-30-phase-one-runtime-resource-access-service-binding-dag.md`
...
- Implementation seam reviewer: completed. The smallest seam is
  `src/spine/derive.ts` plus middle-spine tests; oracle and public
...
- No public dispatcher API, async authoring metadata channel, durable semantics,
  or oracle dispatch materialization was chosen.
...
- `current-lab-state.md`: updated to dispatcher/access async membership experiment.
...
- `systems/runtime-spine-evidence-map.md`: middle-spine row and P0/P1 rows updated to distinguish
  contained proof from public-law `xfail`.
- `ref-runtime-realization-research-program.md`: negative-space ledger updated for
...
- Oracle: no implementation change; oracle gate passed as regression
  coverage.
...
- `phases/phase-one/workstreams/workstream-2026-04-30-phase-one-dispatcher-access-async-step-membership.md`
