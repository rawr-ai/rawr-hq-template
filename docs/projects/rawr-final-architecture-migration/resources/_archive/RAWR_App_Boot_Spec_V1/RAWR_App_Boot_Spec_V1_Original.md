THIS DOCUMENT IS ARCHIVED. DO NOT USE IT AS A REFERENCE FOR CURRENT DECISIONS OR CONTEXT. THIS IS SOLELY A HISTORICAL OR COMPARATIVE REFERENCE. Use the README.md in this directory (RAWR_APP_BOOT_SPEC_V1) as the entrypoint instead.
