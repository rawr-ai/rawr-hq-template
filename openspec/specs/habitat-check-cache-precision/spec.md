# habitat-check-cache-precision Specification

## Purpose
Define how Habitat policy targets fingerprint exact rule authority and inspected
corpora while preserving one cacheable owner-selected execution.
