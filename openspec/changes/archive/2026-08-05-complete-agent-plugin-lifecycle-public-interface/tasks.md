...
- [x] 5.7e22h Close public error authority at the native contract boundary.
  ...
  shared error-data schemas in the TypeBox publication boundary. Admit oRPC's
  exact native item forms with independently optional `message` and `data`,
  including empty and data-only items, without weakening Standard Schema
  authority for present data. Prove
