...
import { claudeCapabilitiesFromHelp } from "../src/adapters/node-claude";
import { codexCapabilitiesFromHelp } from "../src/adapters/node-codex";
import type { ProviderCapability } from "../src/index";
