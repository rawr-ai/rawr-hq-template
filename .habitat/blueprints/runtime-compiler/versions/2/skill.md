---
name: runtime-compiler-v2
description: Private cold runtime compilation with a closed owner-local TypeScript grammar.
---

# Private cold runtime compilation
...
Compilation does not read config, build or acquire providers, bind services, lower adapters, mount harnesses, or publish observations. Its policy asset creates no public SDK face.
