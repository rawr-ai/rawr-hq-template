# RAWR Controller Authority Specification

## Purpose

Define the immutable Template-owned release, selection, verification, and provenance authority for the complete official RAWR controller.
