...
1. [Integrated architecture and runtime spec](../../resources/RAWR_Canonical_Architecture_and_Runtime_Spec_Integrated_Final.md)
   Target-state ontology, runtime subsystem stance, and invariant source of truth.
2. [Effect runtime subsystem spec](../../resources/RAWR_Effect_Runtime_Subsystem_Canonical_Spec.md)
...
5. [Phase 1 closeout review](../../phase-1-closeout-review.md)
...
- [RAWR_Canonical_Architecture_and_Runtime_Spec_Integrated_Final.md](../../resources/RAWR_Canonical_Architecture_and_Runtime_Spec_Integrated_Final.md)
- [RAWR_Effect_Runtime_Subsystem_Canonical_Spec.md](../../resources/RAWR_Effect_Runtime_Subsystem_Canonical_Spec.md)
