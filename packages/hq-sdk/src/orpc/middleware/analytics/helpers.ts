...
export function resolveLocalAnalyticsPayload<TMeta extends BaseMetadata, TContext extends object>(
  context: TContext,
  ...
  return Object.assign({}, ...contributors.map((contributor) => contributor(args) ?? {}));
}
