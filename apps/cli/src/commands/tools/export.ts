...
const TOOLS: ToolExport[] = [
  ...
  { command: "plugins install <pkg>", description: "Install an external Oclif plugin" },
  {
    command: "plugins link <path>",
    description: "Link an external Oclif plugin for development",
  },
  { command: "plugins", description: "List external oclif plugins" },
  { command: "plugins inspect <pkg>", description: "Inspect an external oclif plugin" },
  { command: "plugins update", description: "Update external Oclif plugins" },
