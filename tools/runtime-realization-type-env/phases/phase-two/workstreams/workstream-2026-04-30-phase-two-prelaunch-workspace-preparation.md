...
| --- | --- | --- |
| `workflow-phase-two-level-zero.md` | Active coordination input | Keep active and update checkpoint to mark prelaunch cleanup complete. |
| `workstreams/workstream-2026-04-30-phase-two-spine-composition-program-workstream.md` | Active Level 2 program workstream document | Keep active; next launch anchor. |
| `RUNBOOK.md`, `AGENTS.md`, `guardrails-design.md`, manifest, diagnostic, spine map, focus log, vendor notes | Active authority/status surface | Keep active. |
| `workflow-phased-agent-verification.md`, workstream README/template | Active coordination/process surface | Keep active. |
| `systems/effect-integration-map.md` | Active supporting evidence map | Keep active because current reports still cite it and it summarizes Effect integration status without acting as work plan. |
| `ref-runtime-realization-research-program.md`, `workflow-runtime-research-program-dra.md` | Completed default-program continuity | Keep active but subordinate; headers already mark them closed/non-authoritative. |
| `workflow-effect-integration-work-plan.md` | Stale prior-phase work plan | Archive under `../_archive/pre-phase-two-2026-04-30/`. |
| `workflow-middle-spine-verification-work-plan.md` | Stale prior-phase work plan | Archive under `../_archive/pre-phase-two-2026-04-30/` and remove from required reading. |
| `workflow-runtime-realization-lab-v2-plan.md` | Stale prior-phase implementation plan | Archive under `../_archive/pre-phase-two-2026-04-30/`. |
| `workflow-runtime-spine-diagnostic-work-plan.md` | Completed prior diagnostic work plan | Archive under `../_archive/pre-phase-two-2026-04-30/`. |
...
- Internal adversarial review required structural guard protection for the
  active evidence boundary, current-lab-state/manifest clarification, and explicit
  archive disposition.
...
- `current-lab-state.md` and `proof-manifest.currentExperiment` intentionally still
