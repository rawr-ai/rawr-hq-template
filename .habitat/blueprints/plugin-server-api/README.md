...
owns Elysia and oRPC fetch-transport realization. Habitat/Grit owns the
installed structural relations; native Nx dependency constraints remain a red
installation gap. The closed package shell permits a local `AGENTS.md`; the
