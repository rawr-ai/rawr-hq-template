...
import * as retiredRootSurface from "@habitat-ai/agent-plugin-lifecycle-service";
// @ts-expect-error Retired export host bindings cannot remain package-reachable.
import * as retiredExportBindingSurface from "@habitat-ai/agent-plugin-lifecycle-service/bindings/exports";
// @ts-expect-error Lifecycle host bindings are not a public package axis.
import * as retiredBindingSurface from "@habitat-ai/agent-plugin-lifecycle-service/bindings/providers";
import {
  type Client,
  type Contract,
...
// @ts-expect-error Lifecycle host bindings are not a public package axis.
import * as retiredHostSurface from "@habitat-ai/agent-plugin-lifecycle-service/host";
// @ts-expect-error Raw input parsing belongs to the client face, not a parallel facade.
import * as retiredInputSurface from "@habitat-ai/agent-plugin-lifecycle-service/input";
// @ts-expect-error Retired export module ports cannot remain package-reachable.
import * as retiredExportPortSurface from "@habitat-ai/agent-plugin-lifecycle-service/ports/exports";
// @ts-expect-error Lifecycle module ports are not a public package axis.
import * as retiredPortSurface from "@habitat-ai/agent-plugin-lifecycle-service/ports/providers";
// @ts-expect-error Release construction is private to the lifecycle service.
import * as retiredReleaseSurface from "@habitat-ai/agent-plugin-lifecycle-service/release";
// @ts-expect-error The executable router stays private behind client construction.
import * as retiredRouterSurface from "@habitat-ai/agent-plugin-lifecycle-service/router";
// @ts-expect-error The contract is re-exported only through the client face.
import * as retiredContractSurface from "@habitat-ai/agent-plugin-lifecycle-service/service/contract";
// @ts-expect-error Contract types are exposed only through the public client face.
import * as retiredTypesSurface from "@habitat-ai/agent-plugin-lifecycle-service/types";
...
type LifecycleClientSurface = typeof import("@habitat-ai/agent-plugin-lifecycle-service/client");
