...
assertCondition(
  /requiredMarkers:\s*\[RAWR_MIDDLEWARE_DEDUPE_MARKERS\.RPC_AUTHORIZATION_DECISION\]/.test(
    contextSource
  ),
...
assertCondition(
  scripts["phase-e:e1:full"] ===
    "bun run phase-e:e1:quick && bunx vitest run --project server apps/server/test/rawr.test.ts",
