...
const PUBLIC_JAVASCRIPT_EXPORTS = {
  ...
  "@habitat-ai/sdk": [
    ...
    "@habitat-ai/sdk/plugins/server/mcp",
  ...
  it("installs, executes, and initializes the public SDK and CLI boundary", async () => {
    ...
    await writeFile(
      ...
      [
        ...
        'const mcp = await import("@habitat-ai/sdk/plugins/server/mcp");',
        ...
        "console.log(JSON.stringify({ app: Object.keys(app).sort(), asyncEffect: Object.keys(asyncEffect), asyncPlugins: Object.keys(asyncPlugins).sort(), effect: Object.keys(effect).sort(), execution: Object.keys(execution), mcp: Object.keys(mcp).sort(), providerEffect: Object.keys(providerEffect), providers: Object.keys(providers), profiles: Object.keys(profiles), resources: Object.keys(resources).sort(), runtimeSchema: Object.keys(runtimeSchema), sdk: Object.keys(sdk), schema: Object.keys(schema), serverEffect: Object.keys(serverEffect), serverPlugins: Object.keys(serverPlugins).sort(), service: Object.keys(service), telemetry: Object.keys(telemetry).sort() }));",
      ].join("\n"),
      "utf8"
    );
