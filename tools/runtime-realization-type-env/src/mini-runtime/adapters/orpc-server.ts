...
import type { MiniRuntimeHarnessRecord, StartedMiniServerHarness } from "../harnesses";
...
interface RuntimeOrpcServerContext {
  ...
  readonly harness: StartedMiniServerHarness;
 ...
 * through the RAWR mini harness and ProcessExecutionRuntime. It is not an
