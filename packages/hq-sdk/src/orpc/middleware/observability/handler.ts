...
/**
 * Builds the service-root lifecycle wrapper from one resolved signal profile.
 *
 * @remarks
 * This is the execution boundary shared by tracing and structured logging. It
 * observes the native oRPC procedure lifecycle without contributing context or
 * changing success and failure authority.
 */
