    ...
    projects: [
      {
        ...
        test: {
          ...
          environment: "node",
          exclude: [
            "test/installed-oclif-package-roundtrip.test.ts",
      ...
      },
      {
        ...
        root: r("apps/cli"),
        test: {
          name: "cli-installed-package-acceptance",
          environment: "node",
          fileParallelism: false,
          hookTimeout: 300_000,
          include: ["test/installed-oclif-package-roundtrip.test.ts"],
          testTimeout: 300_000,
        },
      },
      {
      ...
      },
      {
        ...
        test: {
          name: "habitat-cli",
          environment: "node",
          exclude: ["test/installed-temporal-inquiry.test.ts"],
          include: [...includes],
        },
      },
      {
        ...
        root: r("apps/habitat"),
        test: {
          name: "habitat-cli-installed-temporal-inquiry",
          environment: "node",
          fileParallelism: false,
          hookTimeout: 180_000,
          include: ["test/installed-temporal-inquiry.test.ts"],
          testTimeout: 180_000,
        },
      },
      {
      ...
      {
        extends: true,
        root: r("plugins/nx/habitat"),
        test: { name: "plugin-nx-habitat", environment: "node", include: [...includes] },
      },
      {
        extends: true,
