...
7. TypeBox adapter package fixtures (`packages/hq-sdk/src/index.ts` + `typebox-standard-schema.ts`): `SESSION_019c587a_ORPC_CONTRACT_ROUTER_INTEGRATED_RECOMMENDATION.md:457`, `SESSION_019c587a_ORPC_CONTRACT_ROUTER_INTEGRATED_RECOMMENDATION.md:463`
