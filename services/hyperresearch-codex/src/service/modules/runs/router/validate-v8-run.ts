...
/** Observes integrity evidence for the validation operation's terminal verdict. */
...
export const validateV8Run = module.validateV8Run.handler(async ({ context, input }) => {
