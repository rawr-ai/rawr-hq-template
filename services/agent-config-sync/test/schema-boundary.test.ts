...
const schemaLedger: SchemaClassification[] = [
  ...
  { path: "services/agent-config-sync/src/service/modules/retirement/contract.ts", symbol: "CleanupBehindProviderSyncInputSchema", owner: "retirement-contract", form: "typebox" },
  { path: "services/agent-config-sync/src/service/modules/retirement/contract.ts", symbol: "CleanupBehindProviderSyncResultSchema", owner: "retirement-contract", form: "typebox" },
  ...
  { path: "services/agent-config-sync/src/service/modules/retirement/entities.ts", symbol: "CleanupBehindCandidateSchema", owner: "retirement-entity", form: "typebox" },
  { path: "services/agent-config-sync/src/service/modules/retirement/entities.ts", symbol: "CleanupBehindCapabilitiesSchema", owner: "retirement-entity", form: "typebox" },
  { path: "services/agent-config-sync/src/service/modules/retirement/entities.ts", symbol: "CleanupBehindReasonSchema", owner: "retirement-entity", form: "typebox" },
  { path: "services/agent-config-sync/src/service/modules/retirement/entities.ts", symbol: "CleanupBehindVerificationSchema", owner: "retirement-entity", form: "typebox" },
  { path: "services/agent-config-sync/src/service/modules/retirement/entities.ts", symbol: "RetainedResidueSchema", owner: "retirement-entity", form: "typebox" },
